...
public class ConsoleInOut implements InOutInterface {
    ...
    protected final static String defaultListQuetion = "Please select an item";
    protected final static String selectCard = "Please select a card";
    protected final static String wrongIndex = "Please select an index in range.";
    protected final static String enterInteger = "Please enter an integer";
